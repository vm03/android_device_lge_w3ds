...
TARGET_SPECIFIC_HEADER_PATH += device/lge/w3ds/include

# Vendor Init
TARGET_UNIFIED_DEVICE := true
TARGET_INIT_VENDOR_LIB := libinit_msm
#TARGET_LIBINIT_DEFINES_FILE := device/lge/w3ds/init/init_w3ds.c
...
BOARD_HARDWARE_CLASS := device/lge/w3ds/cmhw/

# Bluetooth
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/lge/w3ds/bluetooth
...
TARGET_RECOVERY_FSTAB := device/lge/w3ds/recovery.fstab
...
# Nfc
#BOARD_NFC_HAL_SUFFIX := w3ds
#BOARD_NFC_CHIPSET := pn547

# SELinux
BOARD_SEPOLICY_DIRS += \
	device/lge/w3ds/sepolicy
